...
WDIR=/imppc/labs/maplab/share/izaskun2anna/new_db_regional_profile_data

# for stick
# WDIR=/home/imallona/new_db_regional_profile_data
...
NEWDAT=(ACC DLBC ESCA FPPP KICH LGG MESO OV STAD UCS UVM)
