...
SRC <- '/imppc/labs/maplab/imallona/src/regional_profiler/wanderer_url'
...
url_fields_to_sync <- c("Gene","start","end","nN", "nT")#, "TissueType", "DataType", "plotmean", "geneLine","goButton","Zoom","CpGi","region")
