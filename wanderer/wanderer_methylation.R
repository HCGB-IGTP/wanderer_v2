...
#   if(!is.null(zoom)){
  ...
  if(dim(probes2)[1] > 0){# stop(paste0("wand meth 1 There are not probes in this region"))
...
#           stop(paste0("The maximum number of Normal samples in ", tissue_label, " for ", data_label, " is ", (dim(ddN2)[2]-1)))
#         }
...
#           stop(paste0("The maximum number of Tumoral samples in ", tissue_label, " for ", data_label, " is ", (dim(ddT2)[2]-1)))
#         }
