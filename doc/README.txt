...
3.2. Wanderer_BRCA1_Mean_methylation_brca_Apr_29_2015_at_170440_CEST.png
  A raster version of the previous plot (3.1).
...
3.4. Wanderer_BRCA1_methylation_brca_Apr_29_2015_at_170440_CEST.png
  A raster version of the previous plot (3.3).
...
4.2. Wanderer_BRCA1_Mean_expression_brca_Apr_29_2015_at_170440_CEST.png
  A raster version of the previous plot (4.1).

4.3 Wanderer_BRCA1_boxplot_expression_brca_Apr_29_2015_at_170440_CEST.pdf
...
4.4 Wanderer_BRCA1_boxplot_expression_brca_Apr_29_2015_at_170440_CEST.png
  A raster version of the previous plot (4.4).
 
4.5 Wanderer_BRCA1_expression_brca_Apr_29_2015_at_170440_CEST.pdf
...
4.6 Wanderer_BRCA1_expression_brca_Apr_29_2015_at_170440_CEST.png
  A raster version of the previous plot (4.6).

4.7 Wanderer_BRCA1_expression_brca_Normal_Apr_29_2015_at_170440_CEST.csv
...
4.8 Wanderer_BRCA1_expression_brca_Normal_RNAseqGENE_Apr_29_2015_at_170440_CEST.csv
...
4.9 Wanderer_BRCA1_expression_brca_Tumor_Apr_29_2015_at_170440_CEST.csv
...
4.10 Wanderer_BRCA1_expression_brca_Tumor_RNAseqGENE_Apr_29_2015_at_170440_CEST.csv
...
4.11 Wanderer_BRCA1_expression_brca_annotations_and_statistical_analysis_Apr_29_2015_at_170440_CEST.csv
...
5. Which is the annotations origin for gene names and the like?
  We use the nice paper from Price, Kobor et al. named 'Additional annotation enhances potential for biologically-relevant analysis of the Illumina Infinium HumanMethylation450 BeadChip array' Epigenetics & Chromatin 2013, 6:4  doi:10.1186/1756-8935-6-4.

6. What does RPKM mean? And RSEM? Why do you use them?
  We take advantage of the TCGA pipeline for RNA seq v2 expression analysis. RPKM are used for exons and RSEM for genes. In our plots we log-transform this values adding one to get rid of zeroes; that means we plot log_2(x+1) values. However, the CSVs contain the data as TCGA provides them.
